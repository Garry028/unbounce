    ...
    return (
        ...
        >
            <div className="container mx-auto text-white px-8">
                ...
                <h1 className="text-4xl md:text-6xl font-bold mt-8 mb-4 max-w-4xl text-teal-950"> {/* Decrease font size on small screens */}
                    Describe the <br />value of booking an appointment
                </h1>
