...
const Reviews = () => {
    return (
        <div className="flex flex-col items-center w-full mx-auto md:container md:w-[63%] mb-20">
            {/* #01c4cc */}
            <p className="text-[#01c4cc] text-xs font-medium mb-20">DON'T JUST TAKE OUR WORD FOR IT</p>
            <div className="grid grid-cols-1 md:grid-cols-2 w-full">
                <div className="flex flex-col items-start">
                    <img src={S1} alt="stars" className="w-20 h-auto" />
                    <p className="text-2xl w-[70%] italic mt-2">Share a real testimonial that hits some of your benefits (but isn't too sales-y).</p>
                    <div className="flex gap-5 items-center mt-8">
                        <img src={DP1} alt="stars" className="w-14 h-auto" />
                        <div className="flex flex-col gap-2">
                            <p className="text-xs font-medium">Real Name</p>
