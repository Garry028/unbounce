...
const FeatureBox = ({ src, name, desc }) => {
    return (
        <div className="w-full">
            ...
            <p className="font-semibold text-lg mt-5">{name}</p>
            <p className="font-normal text-sm text-gray-800 w-[80%] mt-2">{desc}</p>
        </div>
    )
}
...
const Features = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 w-full mx-auto md:container md:w-[63%] mb-20 gap-5">
